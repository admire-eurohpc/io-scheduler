...
main(int argc, char* argv[]) {
    ...
    if(argc != 5) {
        ...
        fmt::print(stderr, "Usage: ADM_set_dataset_information <REMOTE_IP> <RESOURCE_ID> <INFO> <JOB_ID>\n");
        exit(EXIT_FAILURE);
    }
    ...
    fmt::print(stdout, "Calling ADM_set_dataset_information remote procedure on {} with resource id {}, info {} and"
    ...
    if (out.ret < 0){
        fmt::print(stdout, "ADM_set_dataset_information remote procedure not completed successfully\n");
    }else{
