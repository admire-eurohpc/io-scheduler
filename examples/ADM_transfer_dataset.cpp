...
main(int argc, char* argv[]) {
    ...
    if(argc != 7) {
        ...
        fmt::print(stderr, "Usage: ADM_transfer_dataset <REMOTE_IP> <SOURCE_LOCATION> <DESTINATION_LOCATION>"
    ...
    fmt::print(stdout, "Calling ADM_transfer_dataset remote procedure on {} : {} -> {} using "
    ...
    if (out.ret < 0){
        fmt::print(stdout, "ADM_transfer_dataset remote procedure not completed successfully\n");
    }else{
