...
ADM_register_adhoc_storage(ADM_server_t server, ADM_job_handle_t job,
    ...
    return admire::register_adhoc_storage(server, job, ctx, adhoc_handle);
}
...
ADM_update_adhoc_storage(ADM_server_t server, ADM_job_handle_t job,
                         ADM_adhoc_context_t ctx,
                         ADM_adhoc_storage_handle_t adhoc_handle) {
    return admire::update_adhoc_storage(server, job, ctx, adhoc_handle);
}

ADM_return_t
ADM_remove_adhoc_storage(ADM_server_t server, ADM_job_handle_t job,
                         ADM_adhoc_storage_handle_t adhoc_handle) {
    return admire::remove_adhoc_storage(server, job, adhoc_handle);
}

ADM_return_t
ADM_deploy_adhoc_storage(ADM_server_t server, ADM_job_handle_t job,
                         ADM_adhoc_storage_handle_t adhoc_handle) {
    return admire::deploy_adhoc_storage(server, job, adhoc_handle);
}
...
ADM_transfer_dataset(ADM_server_t server, ADM_job_handle_t job,
    ...
    return admire::transfer_dataset(server, job, sources, targets, limits,
                                    mapping, tx_handle);
}
...
ADM_set_dataset_information(ADM_server_t server, ADM_job_handle_t job,
    ...
    return admire::set_dataset_information(server, job, target, info);
}
...
ADM_set_io_resources(ADM_server_t server, ADM_job_handle_t job,
    ...
    return admire::set_io_resources(server, job, tier, resources);
}
...
ADM_get_transfer_priority(ADM_server_t server, ADM_job_handle_t job,
    ...
    return admire::get_transfer_priority(server, job, tx_handle, priority);
}

ADM_return_t
ADM_set_transfer_priority(ADM_server_t server, ADM_job_handle_t job,
                          ADM_transfer_handle_t tx_handle, int incr) {
    return admire::set_transfer_priority(server, job, tx_handle, incr);
}
...
ADM_get_pending_transfers(ADM_server_t server, ADM_job_handle_t job,
    ...
    return admire::get_pending_transfers(server, job, pending_transfers);
}

ADM_return_t
ADM_set_qos_constraints(ADM_server_t server, ADM_job_handle_t job,
                        ADM_limit_t limit) {
    return admire::set_qos_constraints(server, job, limit);
}
...
ADM_get_qos_constraints(ADM_server_t server, ADM_job_handle_t job,
                        ...
                        ADM_limit_t** limits) {
    return admire::get_qos_constraints(server, job, scope, entity, limits);
}
...
ADM_define_data_operation(ADM_server_t server, ADM_job_handle_t job,
    ...
    va_list args;
    va_start(args, op);
    auto ret = admire::define_data_operation(server, job, path, op, args);
    va_end(args);
...
ADM_connect_data_operation(ADM_server_t server, ADM_job_handle_t job,
    ...
    auto ret = admire::connect_data_operation(server, job, input, output,
                                              should_stream, args);
    va_end(args);
...
ADM_finalize_data_operation(ADM_server_t server, ADM_job_handle_t job,
    ...
    return admire::finalize_data_operation(server, job, op, status);
}
...
ADM_link_transfer_to_data_operation(ADM_server_t server, ADM_job_handle_t job,
    ...
    va_list args;
    va_start(args, should_stream);
    auto ret = admire::link_transfer_to_data_operation(server, job, op,
                                                       should_stream, args);
    va_end(args);
...
ADM_get_statistics(ADM_server_t server, ADM_job_handle_t job,
    ...
    return admire::get_statistics(server, job, stats);
}
