...
/** Routing information for a dataset */
typedef struct adm_dataset_route* ADM_dataset_route_t;
...
/** A list of dataset routes */
typedef struct adm_dataset_route_list* ADM_dataset_route_list_t;
 ...
 *
 * @param[in] inputs An array of DATASET_ROUTES describing the input
 * information required by the job.
 * @param[in] inputs_len The number of DATASET_ROUTES stored in inputs.
 * @param[in] outputs An array of DATASET_ROUTES describing the output
 * information generated by the job.
 * @param[in] outputs_len The number of DATASET_ROUTES stored in outputs.
 * @param[in] expected_outputs An array of DATASET_ROUTES describing the
 * expected output information generated by the job.
 * @param[in] expected_outputs_len The number of DATASET_ROUTES stored in
 * expected_outputs.
...
/**
 * Create a dataset route from a source and destination dataset.
 *
 * @remark Dataset routes need to be freed by calling
 * ADM_dataset_route_destroy().
 *
 * @param source The source dataset
 * @param destination The destination dataset
 * @return A valid ADM_dataset_route_t if successful or NULL in case of failure.
 */
ADM_dataset_route_t
ADM_dataset_route_create(ADM_dataset_t source, ADM_dataset_t destination);

/**
 * Destroy a dataset route created by ADM_dataset_route_create().
 *
 * @param route A valid ADM_dataset_route_t
 * @return ADM_SUCCESS or corresponding ADM error code
 */
ADM_return_t
